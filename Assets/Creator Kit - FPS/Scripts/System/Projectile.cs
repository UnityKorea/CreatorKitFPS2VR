...
{    
    ...
    private void Start()
    {
        ...
        m_InteractableBase.selectExited.AddListener(DroppedGrenade);

        PoolSystem.Instance.InitPool(PrefabOnDestruction, 16);
    }

    void DroppedGrenade(SelectExitEventArgs args)
    {
        //Debug.Log("DroppedGrenade");
        Launch();
    }
    ...
    void Update()
    {
        //Debug.Log("m_TimeSinceLaunch : " + m_TimeSinceLaunch);
